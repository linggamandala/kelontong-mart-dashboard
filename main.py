...
st.title("Kelontong Mart Dashboard")
st.write(CURR_YEAR)
...
with mx_sales:
    ...
    #menghitung perbandingan penjualan tahun sekarang dan tahun lalu ((current_sales - previous_sales) / previous_sales * 100)
...
with mx_profit_pct:
    ...
    st.metric("Profit %", value=f'{curr_profit_pct:.2f}%', delta=f'{profit_diff_pct:.2f}%')
